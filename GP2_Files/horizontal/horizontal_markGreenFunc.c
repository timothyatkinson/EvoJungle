...
bool horizontal_b0 = true;

static bool evaluateCondition(void)
{
   return (horizontal_b0);
}

static void evaluatePredicatehorizontal_0(Morphism *morphism)
{
   ...
   if(!equalHostLists(array0, array1, list_length0, list_length1)) horizontal_b0 = true;
   else horizontal_b0 = false;
}

static bool match_n0(Morphism *morphism);

bool matchhorizontal_markGreenFunc(Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < horizontal_host->nodes.size; host_index++)
   {
      ...
      do
      {
         ...
         if(result >= 0)
         {
            ...
            evaluatePredicatehorizontal_0(morphism);
...
void applyhorizontal_markGreenFunc(Morphism *morphism, bool record_changes)
{
   ...
   changeNodeMark(horizontal_host, host_node_index, 2);
...
bool fillpothorizontal_markGreenFunc(MorphismPot *pot, Morphism *morphism)
{
   if(1 > horizontal_host->number_of_nodes || 0 > horizontal_host->number_of_edges) return false;
...
static bool fillpot_n0(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < horizontal_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "horizontal_markGreenFunc", horizontal_host);
