...
void applyhorizontal_removeGreyOutputs(Morphism *morphism, bool record_changes)
{
   ...
   if(record_changes)
   {
      Node *node = getNode(horizontal_host, host_node_index);
   ...
   removeNode(horizontal_host, host_node_index);
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "horizontal_removeGreyOutputs", horizontal_host);
