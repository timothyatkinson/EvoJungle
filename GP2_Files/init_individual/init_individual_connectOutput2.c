...
bool init_individual_b8 = true;
bool init_individual_b9 = true;

static bool evaluateCondition(void)
{
   return (init_individual_b8 && init_individual_b9);
}

static void evaluatePredicateinit_individual_8(Morphism *morphism)
{
   ...
   if(!equalHostLists(array0, array1, list_length0, list_length1)) init_individual_b8 = true;
   else init_individual_b8 = false;
}

static void evaluatePredicateinit_individual_9(Morphism *morphism)
{
   int n0 = lookupNode(morphism, 0);
   /* If the node is not yet matched by the morphism, return. */
   if(n0 == -1) return;

   if(getOutdegree(init_individual_host, n0) < 1) init_individual_b9 = true;
   else init_individual_b9 = false;
}
...
bool matchinit_individual_connectOutput2(Morphism *morphism)
{
...
static bool match_n0(Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < init_individual_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         evaluatePredicateinit_individual_9(morphism);
   ...
   for(host_index = 0; host_index < init_individual_host->nodes.size; host_index++)
   {
      ...
      do
      {
         ...
         if(result >= 0)
         {
            ...
            evaluatePredicateinit_individual_8(morphism);
            if(!evaluateCondition())
            {
               /* Reset the boolean variables in the predicates of this variable. */
               init_individual_b8 = true;
               break;
            }
         }
         else break;
...
void applyinit_individual_connectOutput2(Morphism *morphism, bool record_changes)
{
   int host_edge_index;
   int source, target;
...
bool fillpotinit_individual_connectOutput2(MorphismPot *pot, Morphism *morphism)
{
   if(3 > init_individual_host->number_of_nodes || 0 > init_individual_host->number_of_edges) return false;
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < init_individual_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "init_individual_connectOutput2", init_individual_host);
