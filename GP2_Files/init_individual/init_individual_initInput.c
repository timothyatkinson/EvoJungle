...
bool matchinit_individual_initInput(Morphism *morphism)
{
...
void applyinit_individual_initInput(Morphism *morphism, bool record_changes)
{
...
bool fillpotinit_individual_initInput(MorphismPot *pot, Morphism *morphism)
{
   if(1 > init_individual_host->number_of_nodes || 0 > init_individual_host->number_of_edges) return false;
...
static bool fillpot_n0(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < init_individual_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "init_individual_initInput", init_individual_host);
