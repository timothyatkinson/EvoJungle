...
static void evaluatePredicatelocal_edge_crossover_1(Morphism *morphism)
{
   ...
   if(var_7 + var_8 <= var_10) local_edge_crossover_b1 = true;
...
bool matchlocal_edge_crossover_crossover_point2(Morphism *morphism)
{
...
static bool match_e0(Morphism *morphism)
{
   ...
   for(counter = 0; counter < host_node->out_edges.size + 2; counter++)
   {
      ...
      do
      {
         ...
         /* Matching rule atom 2 */
         if(item->atom.type != 's') break;
         else if(strcmp(item->atom.str, "CROSS") != 0) break;
         item = item->prev;
...
void applylocal_edge_crossover_crossover_point2(Morphism *morphism, bool record_changes)
{
   ...
   changeRoot(local_edge_crossover_host, host_node_index);
...
bool fillpotlocal_edge_crossover_crossover_point2(MorphismPot *pot, Morphism *morphism)
{
   if(5 > local_edge_crossover_host->number_of_nodes || 2 > local_edge_crossover_host->number_of_edges) return false;
...
static bool fillpot_n3(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "local_edge_crossover_crossover_point2", local_edge_crossover_host);
