...
bool matchlocal_edge_crossover_makeBlueRed(Morphism *morphism)
{
...
void applylocal_edge_crossover_makeBlueRed(Morphism *morphism, bool record_changes)
{
   ...
   changeEdgeMark(local_edge_crossover_host, host_edge_index, 1);
...
bool fillpotlocal_edge_crossover_makeBlueRed(MorphismPot *pot, Morphism *morphism)
{
   if(2 > local_edge_crossover_host->number_of_nodes || 1 > local_edge_crossover_host->number_of_edges) return false;
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "local_edge_crossover_makeBlueRed", local_edge_crossover_host);
