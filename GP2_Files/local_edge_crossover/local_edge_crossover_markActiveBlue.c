...
bool matchlocal_edge_crossover_markActiveBlue(Morphism *morphism)
{
...
void applylocal_edge_crossover_markActiveBlue(Morphism *morphism, bool record_changes)
{
   int host_node_index = lookupNode(morphism, 1);
   HostLabel label_n1 = getNodeLabel(local_edge_crossover_host, host_node_index);
   if(record_changes) pushRemarkedNode(host_node_index, label_n1.mark);
   changeNodeMark(local_edge_crossover_host, host_node_index, 4);
...
bool fillpotlocal_edge_crossover_markActiveBlue(MorphismPot *pot, Morphism *morphism)
{
   if(2 > local_edge_crossover_host->number_of_nodes || 1 > local_edge_crossover_host->number_of_edges) return false;
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "local_edge_crossover_markActiveBlue", local_edge_crossover_host);
