#include "local_edge_crossover_markBlueGrey.h"

#include "local_edge_crossover.h"

static bool match_n0(Morphism *morphism);

bool matchlocal_edge_crossover_markBlueGrey(Morphism *morphism)
{
...
void applylocal_edge_crossover_markBlueGrey(Morphism *morphism, bool record_changes)
{
...
bool fillpotlocal_edge_crossover_markBlueGrey(MorphismPot *pot, Morphism *morphism)
{
   if(1 > local_edge_crossover_host->number_of_nodes || 0 > local_edge_crossover_host->number_of_edges) return false;
...
static bool fillpot_n0(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < local_edge_crossover_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "local_edge_crossover_markBlueGrey", local_edge_crossover_host);
