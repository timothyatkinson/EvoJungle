...
bool matchlocal_edge_crossover_markGreenFunc(Morphism *morphism)
{
...
void applylocal_edge_crossover_markGreenFunc(Morphism *morphism, bool record_changes)
{
...
bool fillpotlocal_edge_crossover_markGreenFunc(MorphismPot *pot, Morphism *morphism)
{
   if(2 > local_edge_crossover_host->number_of_nodes || 1 > local_edge_crossover_host->number_of_edges) return false;
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "local_edge_crossover_markGreenFunc", local_edge_crossover_host);
