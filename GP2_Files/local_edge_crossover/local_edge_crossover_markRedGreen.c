...
bool matchlocal_edge_crossover_markRedGreen(Morphism *morphism)
{
...
void applylocal_edge_crossover_markRedGreen(Morphism *morphism, bool record_changes)
{
...
bool fillpotlocal_edge_crossover_markRedGreen(MorphismPot *pot, Morphism *morphism)
{
   if(1 > local_edge_crossover_host->number_of_nodes || 0 > local_edge_crossover_host->number_of_edges) return false;
...
static bool fillpot_n0(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < local_edge_crossover_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "local_edge_crossover_markRedGreen", local_edge_crossover_host);
