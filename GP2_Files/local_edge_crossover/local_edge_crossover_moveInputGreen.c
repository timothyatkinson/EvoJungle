...
bool matchlocal_edge_crossover_moveInputGreen(Morphism *morphism)
{
   if(3 > local_edge_crossover_host->number_of_nodes || 1 > local_edge_crossover_host->number_of_edges) return false;
...
void applylocal_edge_crossover_moveInputGreen(Morphism *morphism, bool record_changes)
{
...
bool fillpotlocal_edge_crossover_moveInputGreen(MorphismPot *pot, Morphism *morphism)
{
   if(3 > local_edge_crossover_host->number_of_nodes || 1 > local_edge_crossover_host->number_of_edges) return false;
...
static bool fillpot_n2(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < local_edge_crossover_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "local_edge_crossover_moveInputGreen", local_edge_crossover_host);
