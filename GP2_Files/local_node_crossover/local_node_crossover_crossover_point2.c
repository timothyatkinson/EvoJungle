...
static void evaluatePredicatelocal_node_crossover_1(Morphism *morphism)
{
   ...
   if(var_7 + var_8 <= var_10) local_node_crossover_b1 = true;
...
bool matchlocal_node_crossover_crossover_point2(Morphism *morphism)
{
...
void applylocal_node_crossover_crossover_point2(Morphism *morphism, bool record_changes)
{
...
bool fillpotlocal_node_crossover_crossover_point2(MorphismPot *pot, Morphism *morphism)
{
   if(5 > local_node_crossover_host->number_of_nodes || 2 > local_node_crossover_host->number_of_edges) return false;
...
static bool fillpot_n3(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "local_node_crossover_crossover_point2", local_node_crossover_host);
