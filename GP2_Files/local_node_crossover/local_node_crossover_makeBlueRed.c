...
bool matchlocal_node_crossover_makeBlueRed(Morphism *morphism)
{
...
void applylocal_node_crossover_makeBlueRed(Morphism *morphism, bool record_changes)
{
...
bool fillpotlocal_node_crossover_makeBlueRed(MorphismPot *pot, Morphism *morphism)
{
   if(2 > local_node_crossover_host->number_of_nodes || 1 > local_node_crossover_host->number_of_edges) return false;
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "local_node_crossover_makeBlueRed", local_node_crossover_host);
