...
bool matchlocal_node_crossover_markBlueGrey(Morphism *morphism)
{
...
void applylocal_node_crossover_markBlueGrey(Morphism *morphism, bool record_changes)
{
...
bool fillpotlocal_node_crossover_markBlueGrey(MorphismPot *pot, Morphism *morphism)
{
   if(1 > local_node_crossover_host->number_of_nodes || 0 > local_node_crossover_host->number_of_edges) return false;
...
static bool fillpot_n0(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < local_node_crossover_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "local_node_crossover_markBlueGrey", local_node_crossover_host);
