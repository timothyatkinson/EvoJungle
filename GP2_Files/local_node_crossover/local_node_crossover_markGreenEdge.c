...
bool matchlocal_node_crossover_markGreenEdge(Morphism *morphism)
{
...
void applylocal_node_crossover_markGreenEdge(Morphism *morphism, bool record_changes)
{
   ...
   changeEdgeMark(local_node_crossover_host, host_edge_index, 1);
...
bool fillpotlocal_node_crossover_markGreenEdge(MorphismPot *pot, Morphism *morphism)
{
   if(2 > local_node_crossover_host->number_of_nodes || 1 > local_node_crossover_host->number_of_edges) return false;
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "local_node_crossover_markGreenEdge", local_node_crossover_host);
