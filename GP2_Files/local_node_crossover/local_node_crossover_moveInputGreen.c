...
bool local_node_crossover_b3 = true;

static bool evaluateCondition(void)
{
   return (local_node_crossover_b3);
}

static void evaluatePredicatelocal_node_crossover_3(Morphism *morphism)
{
   ...
   if(var_4 == var_5) local_node_crossover_b3 = true;
   else local_node_crossover_b3 = false;
}
...
bool matchlocal_node_crossover_moveInputGreen(Morphism *morphism)
{
   if(3 > local_node_crossover_host->number_of_nodes || 1 > local_node_crossover_host->number_of_edges) return false;
...
static bool match_n1(Morphism *morphism, Edge *host_edge)
{
   ...
   do
   {
      ...
      if(result >= 0)
      {
         ...
         evaluatePredicatelocal_node_crossover_3(morphism);
         if(!evaluateCondition())
         {
            /* Reset the boolean variables in the predicates of this variable. */
            local_node_crossover_b3 = true;
            break;
         }
      }
      else break;
...
void applylocal_node_crossover_moveInputGreen(Morphism *morphism, bool record_changes)
{
...
bool fillpotlocal_node_crossover_moveInputGreen(MorphismPot *pot, Morphism *morphism)
{
   if(3 > local_node_crossover_host->number_of_nodes || 1 > local_node_crossover_host->number_of_edges) return false;
...
static bool fillpot_n2(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < local_node_crossover_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "local_node_crossover_moveInputGreen", local_node_crossover_host);
