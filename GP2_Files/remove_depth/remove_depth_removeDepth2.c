...
bool matchremove_depth_removeDepth2(Morphism *morphism)
{
...
void applyremove_depth_removeDepth2(Morphism *morphism, bool record_changes)
{
...
bool fillpotremove_depth_removeDepth2(MorphismPot *pot, Morphism *morphism)
{
   if(1 > remove_depth_host->number_of_nodes || 0 > remove_depth_host->number_of_edges) return false;
...
static bool fillpot_n0(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < remove_depth_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "remove_depth_removeDepth2", remove_depth_host);
